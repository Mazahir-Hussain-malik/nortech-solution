    ...
    <main className="bg-white min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-8 py-16">
        ...
        <motion.div {...fadeInUp} className="mb-12">
          <h1 className="text-5xl font-black text-gray-900 mb-4  uppercase">beautician</h1>
          <div className="w-24 h-1 bg-orange-500"></div>
        </motion.div>

        {/* Subheading and Description */}
        <motion.div {...fadeInUp} className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 uppercase">beautician TRAINING & SERVICES</h2>
                                ...
                                <table className="w-full text-sm md:text-base border-separate border-spacing-1 border border-gray-400 dark:border-gray-500">
                                    <thead>
                                        <tr className="bg-cyan-700 text-white">
                                            ...
                                            <th className="px-4 py-3 text-left font-semibold">beautician</th>
