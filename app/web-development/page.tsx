                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-8">
                        <h1 className="text-5xl md:text-6xl font-bold text-foreground mb-2">
                            <span className="relative before:content-[''] before:absolute before:-bottom-1 before:left-0 before:w-full before:h-[12px] before:bg-[#E97D26]">WEB DEVELOPMENT</span>
                        </h1>
                    </div>
                    ...
                    <div className="space-y-4 text-base md:text-lg text-foreground leading-relaxed max-w-4xl">
                        <p>
                            Nortech Solution Offers Top-Tier Web Development Training & Services, Equipping individuals and Businesses with cutting-Edge Skills to Thrive in The Digital World Our Training Programs are Designed For Beginners and Professinals Alike Covering Frotend, Backend, and Fullstack Development using The Latest Technologies like 
                            Tools Like <span className="text-[#E97D26] font-semibold">HTML</span>,{" "}
                            <span className="text-[#E97D26] font-semibold">CSS</span>,{" "}
                            <span className="text-[#E97D26] font-semibold">JavaScript</span>,{" "}
                            <span className="text-[#E97D26] font-semibold">React</span>, {" "}
                            <span className="text-[#E97D26] font-semibold">Nodejs </span>, And{" "}more
