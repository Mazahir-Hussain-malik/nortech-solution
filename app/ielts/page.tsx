    ...
    <main className="bg-white min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-8 py-16">
        ...
        <motion.div {...fadeInUp} className="mb-12">
          <h1 className="text-5xl font-black text-gray-900 mb-4">Ielts</h1>
          <div className="w-24 h-1 bg-orange-500"></div>
        </motion.div>

        {/* Subheading and Description */}
        <motion.div {...fadeInUp} className="mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Ielts TRAINING</h2>

          <p className="text-base text-gray-700 leading-7 mb-6">
          Nortech Solution, in collaboration with Nevttac, offers ILET training, equipping 30+ students with the skills needed to excel in the exam. Our comprehensive training program focuses on language proficiency, test-taking strategies, and practical exercises to ensure success in the ILET assessment.
          </p>
        </motion.div>
